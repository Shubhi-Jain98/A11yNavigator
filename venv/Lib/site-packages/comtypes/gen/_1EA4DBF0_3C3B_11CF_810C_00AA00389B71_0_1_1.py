...
typelib_path = 'C:\\Windows\\SysWOW64\\oleacc.dll'
WSTRING = c_wchar_p
...
__all__ = [
    'CAccPropServices', 'ANNO_THIS', 'ANNO_CONTAINER', 'IAccessible',
    'IAccessibleHandler', 'AnnoScope', 'IAccPropServices',
    'wireHMENU', '_RemotableHandle', '__MIDL_IWinTypes_0009',
    'IAccIdentity', 'IAccPropServer'
]

_check_version('1.2.0', 1700029834.547224)

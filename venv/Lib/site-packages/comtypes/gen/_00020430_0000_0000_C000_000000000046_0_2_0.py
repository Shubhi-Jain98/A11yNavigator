...
__all__ = [
    'OLE_XSIZE_HIMETRIC', 'FontEvents', 'VgaColor',
    'FONTSTRIKETHROUGH', 'IFontDisp', 'Gray', 'OLE_YSIZE_PIXELS',
    'FONTITALIC', 'FONTSIZE', 'OLE_XPOS_HIMETRIC',
    'OLE_YSIZE_CONTAINER', 'Color', 'OLE_COLOR', 'FONTUNDERSCORE',
    'OLE_XPOS_CONTAINER', 'LoadPictureConstants', 'OLE_XPOS_PIXELS',
    'OLE_OPTEXCLUSIVE', 'Unchecked', 'OLE_ENABLEDEFAULTBOOL',
    'Checked', 'StdFont', 'IPicture', 'OLE_YPOS_HIMETRIC',
    'IPictureDisp', 'OLE_CANCELBOOL', 'OLE_HANDLE', 'OLE_YPOS_PIXELS',
    'StdPicture', 'Picture', 'OLE_XSIZE_CONTAINER', 'Monochrome',
    'Default', 'OLE_TRISTATE', 'IFont', 'IFontEventsDisp',
    'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS', 'FONTNAME', 'FONTBOLD',
    'Font', 'OLE_YPOS_CONTAINER'
]

_check_version('1.2.0', 1575709751.817330)

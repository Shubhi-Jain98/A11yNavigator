...
def traverse_whole_website_single_key():
    ...
    # single_keys_list = [simulate_f_form_key, simulate_shift_f_form_key]

    for func in single_keys_list:
        ...
        while True:
            ...
            extract_xpath_focussed_ele(driver, "single_key", get_focused_element_name(), get_focused_element_value(),
